...
public class PlanoDeSaudeDAO { // Simular nosso banco de dados
    ...
    public static void criarPlanosDeSaudeTeste() {
        ...
        PlanoDeSaude p3 = new PlanoDeSaude("Amil", "Bronze");
        PlanoDeSaude p4 = new PlanoDeSaude("Notredame", "Ouro");
        planos.add(p1);
        planos.add(p2);
        planos.add(p3);
        planos.add(p4);
    ...
    public static DefaultTableModel getTableModel() {
        ...
        //arraylist plaos e separar cada dado na matriz dados
        ...
        // Definir um vetor com os nomes das colunas das tabelas
        
        String[] titulos = {"Códigos","Operadora","Tipo de plano"};
